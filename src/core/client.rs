...
impl Connector {
    ...
    pub fn connect<S: Read + Write>(&mut self, stream: S) -> RdpResult<RdpClient<S>> {
        ...
        let mut tcp = Link::new(Stream::Raw(stream));
        ...
        let session_selection = super::peps::SessionSelectionPDU::with_unicode_id(
            "a5e08a6c-aede-4c75-8c62-7201a317105c;EnhancedMode=1\0",
        );
        tcp.write(&session_selection)?;
        // TODO send PreconnectionPDU before sending any other data on the wire.
